    ...
    <div className="exchange-box order-box">
      ...
      <div id="pills-tabContent" className="tab-content">
        ...
        >
          ...
          {JSON.stringify(OpenCloseStopLimitCoinData)}
          {orderType === 3 && (
            <BuyStopLimit
              dashboard={dashboard}
        ...
        >
          ...
          >
            <li
              ...
              onClick={() => {
                setcloseSelectedTab(LIMIT_ORDER);
              }}
            >
              <a
                id="sell-Limit-tab"
            ...
            <li
              ...
              className="nav-item sellBox"
              onClick={() => {
                setcloseSelectedTab(MARKET_ORDER);
              }}
            >
              <a
                id="sell-Market-tab"
            ...
            <li role="presentation" className="nav-item sellBox">
              <a
                ...
                className="nav-link"
                onClick={() => {
                  setcloseSelectedTab(STOP_LIMIT_ORDER);
                }}
              >
                {t("Stop Limit")}
              </a>
            ...
            <li role="presentation" className="nav-item sellBox">
              <a
                ...
                className="nav-link"
                onClick={() => {
                  setcloseSelectedTab(STOP_MARKET_ORDER);
                }}
              >
                {t("Stop Market")}
              </a>
