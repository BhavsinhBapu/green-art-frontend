    ...
    <div className="col-12 mt-4">
                ...
                <div className="P2psearchBox position-relative">
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      if (
                        isNaN(newValue) ||
                        newValue < parseFloat(limit.min_limit)
                      ) {
                        setMinError(
                          "Min limit must be at least " + limit.min_limit
                        );
                      } else {
                        setMinError("");
                        setAmount({
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      if (
                        ...
                        parseFloat(limit.maximum_price)
                      ) {
                        setMaxError(
                          "Max limit must be at least " + limit.min_limit
                        );
                      } else {
                        setAmount({
                          ...amount,
      ...
      <div className="addPostNextButton mt-3">
        ...
        <div>
          ...
          {selectedPayment.length > 0 && selectedPaymentTime && (
            <button
